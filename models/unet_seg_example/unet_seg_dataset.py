...
from models.unet_seg_example.model.utils.dataset import BasicDataset

current_path = os.path.dirname(os.path.abspath(__file__))
IMAGE_DIR = os.path.join(current_path, 'data/unet_seg/imgs/')
MASK_DIR = os.path.join(current_path, 'data/unet_seg/masks/')
